...
function  theta_c = altitude_hold(h_c, h, flag, P)
    ...
    error = h_c - h;
    integratorchi = integratorchi+P.Ts*error;
    theta_c = sat(P.kp_h*error+P.ki_h*integratorchi,P.theta_max,-P.theta_max);
end
...
function theta_c = airspeed_with_pitch_hold(Va_c, Va, flag, P)
    ...
    error = Va_c - Va;
    integratorchi = integratorchi+P.Ts*error;
    theta_c = sat(P.kp_V2*error+P.ki_V2*integratorchi,P.theta_max,-P.theta_max);
end
...
function delta_t = airspeed_with_throttle_hold(Va_c, Va, flag, P)
    ...
    error = Va_c - Va;
    integratorchi = integratorchi+P.Ts*error;
    delta_t = sat(P.kp_V*error+P.ki_V*integratorchi,P.theta_max,-P.theta_max);
